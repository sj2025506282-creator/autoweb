...
const verifiedNossaCasaMenu = [
  ...
  ["From the Sea", "Cured Fish of the Day", "Delicately cured seasonal fish with bright citrus and fresh herbs", 0, ""],
  ["From the Sea", "Scallops", "Seared scallops with a silky seasonal purée and aromatic herb oil", 0, ""],
  ["From the Sea", "Seafood Curry", "Market seafood in a fragrant, gently spiced coconut curry", 0, ""],
  ["From the Sea", "Clams Rice", "Creamy Portuguese-style rice with clams, herbs and coastal aromatics", 0, ""],
  ["From the Land", "Beef Tartare", "Hand-cut beef with house seasoning, cured yolk and crisp toast", 0, ""],
  ["From the Land", "Galta de Ternera", "Slow-braised veal cheek with a rich reduction and seasonal garnish", 0, ""],
  ["From the Land", "Pork Cheek Tacos", "Tender pork cheek, fresh salsa and herbs in soft corn tortillas", 0, ""],
  ["From the Land", "Beef Cheek Croquete", "Crisp beef cheek croquette with a creamy centre and house sauce", 0, ""],
  ["From the Land", "Pork Ribs", "Slow-cooked pork ribs finished with a glossy savoury glaze", 0, ""],
] as const;
